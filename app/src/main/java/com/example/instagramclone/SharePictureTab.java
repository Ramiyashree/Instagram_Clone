        ...
        switch (view.getId())
        {
            ...
            case R.id.btnShareImage:
                ...
                if(receivedImageBitmap!= null)
                {
                          ...
                          {
                              FancyToast.makeText(getContext(), "There must be a description" , Toast.LENGTH_LONG, FancyToast.ERROR, true).show();
                          ...
                          else
                          {
                              ...
                              parseObject.saveInBackground(new SaveCallback() {
                                  ...
                                  public void done(ParseException e) {
                                      if(e == null)
                                      {
                                          FancyToast.makeText(getContext(), "Done!!!" , Toast.LENGTH_LONG, FancyToast.INFO, true).show();
                                      }
                                      else
                                      {
                ...
                {
                    FancyToast.makeText(getContext(), " Error you cant select image", Toast.LENGTH_SHORT, FancyToast.ERROR, true).show();
