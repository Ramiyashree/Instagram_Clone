...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (view.getId()) {
            case R.id.btnSignUp:
                if (edtEmail.getText().toString().equals("") ||
                    ...
                    FancyToast.makeText(MainActivity.this, "Email and username and password is required", Toast.LENGTH_SHORT, FancyToast.INFO, true).show();
                        transitionToSocialMediaActivity();
                } else {
    ...
    public void rootLayoutTapped(View view) {
        try {
            ...
            imputMethodManager.hideSoftInputFromWindow(getCurrentFocus().getWindowToken(), 0);
        } catch (Exception e) {
            e.printStackTrace();
